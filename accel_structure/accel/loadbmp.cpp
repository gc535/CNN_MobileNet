...
int load_bmp(const char *filepath, unsigned char b[][224], unsigned char g[][224], unsigned char r[][224]){
//int load_bmp(int argc, char **argv, float input[MAX_FMAP_SIZE]){
    ...
    // the following code is only for writing color map data into txt file
